...
control "cis_v160_7_1" {
  ...
  description   = "We should ensure that the minimum number of required manager nodes is created in a
swarm."
...
control "cis_v160_7_7" {
  ...
  description   = "We should rotate swarm node certificates in line with your organizational security
policy."
