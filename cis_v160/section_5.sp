...
control "cis_v160_5_10" {
  ...
  query         = query.container_host_network_namespace_shared
...
control "cis_v160_5_11" {
  ...
  query         = query.container_memory_usage_limit
...
control "cis_v160_5_12" {
  ...
  query         = query.container_cpu_priority_set
...
control "cis_v160_5_13" {
  ...
  query         = query.container_root_filesystem_mounted
...
control "cis_v160_5_15" {
  ...
  query         = query.container_restart_policy_on_failure
...
control "cis_v160_5_16" {
  ...
  query         = query.container_host_process_namespace_shared
...
control "cis_v160_5_17" {
  ...
  query         = query.container_host_ipc_namespace_shared
...
control "cis_v160_5_21" {
  ...
  query         = query.container_host_uts_namespace_shared
...
control "cis_v160_5_22" {
  ...
  query         = query.container_default_seccomp_profile_disabled
...
control "cis_v160_5_25" {
  ...
  query         = query.container_cgroup_usage
...
control "cis_v160_5_26" {
  ...
  query         = query.container_no_new_privileges
...
control "cis_v160_5_29" {
  ...
  query         = query.container_pid_cgroup_limit_used
...
control "cis_v160_5_31" {
  ...
  query         = query.container_host_user_namespace_shared
